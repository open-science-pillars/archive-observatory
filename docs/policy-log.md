# Publication policy log

One entry per delivery or publication event; newest first. The policy
itself is docs/publication-policy.md.
...
- 2026-08-30 · POCLOUD sweep (982 collections, 5 structural rules).
  ...
  only, by rule: what ran, at what scale, what was delivered privately,
  the window dates, and what is held and why; result content of any
  resolution waits for the tier that covers it. Observatory-side work
  queued from this sweep: a three-state doi-present refinement in the
  sweeper.
